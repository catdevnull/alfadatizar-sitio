...
async function loadSvg(path) {
	const f = await readFile(path, "utf-8");
	return (props) => {
		let s = f;
		...
		<html lang="es">
			...
			<body class="flex flex-col font-sans">
				...
				<section class="bg-blanco">
					<div class="mx-auto max-w-5xl p-2">
						...
						<div class="flex items-center gap-4">
							<Wave
								containerClass="mx-8 w-full shrink-[2] max-w-[10vw]"
								class="w-full"
							/>
							<img
					...
					{data.frontpageFooterButtons.map(
						({ content, buttonText, buttonUrl }) => (
							<>
								...
								<a
									href={buttonUrl}
									class="mb-6 px-4 py-3 font-bold outline outline-1 outline-[black]"
								>
									{buttonText}
								</a>
							</>
				...
				<section class="flex flex-wrap items-end justify-between gap-8 bg-violeta px-[10%] py-24">
					...
					{/* TODO: activar mail */}
					<a class="text-xl" href="mailto:info@alfadatizar.org">
						info@alfadatizar.org
					</a>
				</section>
			</body>
		</html>
